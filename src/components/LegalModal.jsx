...
const CONTENT = {
  fr: {
    ...
    cgu: {
      ...
      paragraphs: [
        `Les présentes Conditions Générales d'Utilisation ("CGU") régissent l'accès et l'utilisation de la plateforme relief.lu, éditée par ${COMPANY} (SARL-S en cours de constitution), dont le siège social est situé ${ADDRESS}. Ce texte, rédigé pour ce type de plateforme, sera revu par un professionnel du droit avant une exploitation à grande échelle.`,
        {
  ...
  en: {
    ...
    cgu: {
      ...
      paragraphs: [
        `These Terms of Service ("Terms") govern access to and use of the relief.lu platform, published by ${COMPANY} (SARL-S being incorporated), with registered office at ${ADDRESS}. This text, written for this type of platform, will be reviewed by a legal professional before large-scale operation.`,
        {
