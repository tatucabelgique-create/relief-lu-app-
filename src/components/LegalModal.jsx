...
const CONTENT = {
  fr: {
    mentions: {
      ...
      paragraphs: [
        "En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est précisé aux utilisateurs du site internet relief.lu l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi :",
        `Propriétaire : ${COMPANY} (société en cours de constitution) — Contact : ${CONTACT} — Adresse : ${ADDRESS}.`,
        `Responsable de la publication : ${COMPANY} — Contact : ${CONTACT}.`,
        `Webmaster : ${COMPANY} — Contact : ${CONTACT}.`,
        "Hébergeur : GitHub, Inc. — 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, États-Unis (GitHub Pages).",
  ...
  de: {
    mentions: {
      title: "Impressum",
      paragraphs: [
        "Den Nutzer:innen der Website relief.lu wird hiermit die Identität der an ihrer Erstellung und Betreuung beteiligten Akteure mitgeteilt:",
        `Eigentümer: ${COMPANY} (Gesellschaft in Gründung) — Kontakt: ${CONTACT} — Adresse: ${ADDRESS}.`,
        `Für den Inhalt Verantwortliche/r: ${COMPANY} — Kontakt: ${CONTACT}.`,
        `Webmaster: ${COMPANY} — Kontakt: ${CONTACT}.`,
        "Hosting-Anbieter: GitHub, Inc. — 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, USA (GitHub Pages).",
  ...
  en: {
    mentions: {
      title: "Legal notice",
      paragraphs: [
        "Users of the relief.lu website are informed of the identity of the various parties involved in its creation and operation:",
        `Owner: ${COMPANY} (company being incorporated) — Contact: ${CONTACT} — Address: ${ADDRESS}.`,
        `Publication manager: ${COMPANY} — Contact: ${CONTACT}.`,
        `Webmaster: ${COMPANY} — Contact: ${CONTACT}.`,
        "Host: GitHub, Inc. — 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, United States (GitHub Pages).",
