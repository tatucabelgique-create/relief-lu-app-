  ...
  fr: {
    mentions: {
      ...
      paragraphs: [
        ...
        `Contact : ${CONTACT}`,
        "Les mentions complémentaires (gérant, numéro RCS, capital social, numéro de TVA) seront complétées dès l'immatriculation effective de la société.",
  ...
  de: {
    mentions: {
      ...
      paragraphs: [
        ...
        `Kontakt: ${CONTACT}`,
        "Die ergänzenden Angaben (Geschäftsführer, Handelsregisternummer, Stammkapital, Umsatzsteuer-Identifikationsnummer) werden nach der endgültigen Eintragung der Gesellschaft ergänzt.",
  ...
  en: {
    mentions: {
      ...
      paragraphs: [
        ...
        `Contact: ${CONTACT}`,
        "Additional details (managing director, company registration number, share capital, VAT number) will be completed once the company is formally incorporated.",
